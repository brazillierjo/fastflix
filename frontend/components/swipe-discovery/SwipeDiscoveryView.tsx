...
export default function SwipeDiscoveryView({
  ...
  const renderItem = (item: MovieResult, index: number) => {
    // Premium gate: for free users, show CTA after limit
    if (!hasUnlimitedAccess && index >= FREE_SWIPE_LIMIT) {
      return null; // Will be replaced by premium gate page
    }
