  ...
  return (
    ...
    >
      <View className='flex-row items-center border-b border-neutral-200 bg-light-background dark:border-neutral-700 dark:bg-dark-background'>
        ...
        <Text className='mr-10 flex-1 text-center text-lg font-semibold text-light-text dark:text-dark-text'>
                  ...
                  >
                    <View className='flex-row'>
                      ...
                      <View className='flex-1'>
                        <Text className='mb-1 text-base font-semibold leading-5 text-light-text dark:text-dark-text'>
                        ...
                        {streamingProviders[movie.id] &&
                          streamingProviders[movie.id].length > 0 && (
                            <View className='flex-row items-center gap-2'>
                              ...
                              <Text className='text-xs font-medium text-light-text dark:text-dark-text'>
